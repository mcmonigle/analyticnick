...
export default function About() {
    function AboutText() { 
        ...
        <p>I have a B.S. with majors in Statistics and Mathematics from the University of Minnesota 
            and I'm currently pursuing a M.E. in Systems Engineering from the University of Virginia.
            I have a professional background in data science, web application development,
            economic research, defense, and intelligence.</p>
        ...
        <p>Please contact me at "lastname.dev@gmail.com" where lastname=mcmonigle, or message me <a href='https://www.linkedin.com/in/nicholasmcmonigle' style={{color: 'rgb(136, 190, 233)', textDecoration: 'none'}}>on LinkedIn</a>.</p>
